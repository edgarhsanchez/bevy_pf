...
| Animation / PropertyAnimation | `--example wpf_samples_gallery` | PropertyTriggerExample near-verbatim (Enter/ExitActions); DataTrigger/Storyboard variants tracked; keyframed Loaded storyboard added |
